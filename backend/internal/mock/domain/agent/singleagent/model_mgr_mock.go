...
// Source: backend/infra/modelmgr/modelmgr.go
//
// Generated by this command:
//
//	mockgen --destination backend/internal/mock/domain/agent/singleagent/model_mgr_mock.go --package mock -source backend/infra/modelmgr/modelmgr.go
//
